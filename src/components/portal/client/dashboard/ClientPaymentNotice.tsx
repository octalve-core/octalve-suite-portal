        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          {isUnpaid ? (
            <button
              ...
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-[#0064E0] px-5 text-sm font-bold text-white shadow-[0_16px_34px_rgba(0,100,224,0.18)] transition hover:bg-[#0052B8]"
            >
              <CreditCard size={17} />
              Pay Now
            </button>
          ) : (
            <span className="inline-flex min-h-12 items-center justify-center rounded-2xl border border-orange-200 bg-white px-5 text-sm font-bold text-orange-700">
          ...
          <Link
            ...
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl border border-orange-200 bg-white px-5 text-sm font-bold text-slate-700 transition hover:bg-orange-50 hover:text-orange-700"
          >
            Open Payments
            <ArrowRight size={17} />
          </Link>
