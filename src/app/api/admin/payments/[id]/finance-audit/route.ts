...
function serializePaymentTransaction(transaction: AuditTransaction) {
  return {
    ...
    webhookLinked: Boolean(transaction.webhookEventId),
    provider: transaction.provider,
    status: transaction.status,
    amount: transaction.amount,
    currency: transaction.currency,
    reference: transaction.reference ? "Recorded" : undefined,
    providerRecord: Boolean(transaction.providerReference),
    ...
    failureRecorded: Boolean(transaction.failureReason),
...
export async function GET(_request: Request, { params }: Params) {
  ...
  return noStoreJson({
    payment: {
      ...
      gatewayRecord: Boolean(payment.gatewayReference),
      providerRecord: Boolean(payment.providerReference),
