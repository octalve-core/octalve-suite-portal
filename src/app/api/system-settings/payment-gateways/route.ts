...
function serializeGateway(setting: GatewayDefault & { id?: string; createdAt?: Date; updatedAt?: Date }) {
  return {
    ...
    publicKeyEnvName: setting.publicKeyEnvName ?? undefined,
    secretKeyEnvName: setting.secretKeyEnvName ?? undefined,
    webhookSecretEnvName: setting.webhookSecretEnvName ?? undefined,
